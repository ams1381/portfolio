...
export const Footer = () => {
    ...
    return <footer className={'absolute bottom-7 left-1/2 -translate-x-1/2 md:left-6 md:translate-x-0 !md:transform-none'}>
        <ul className={'flex gap-3 items-center'}>
            <li>
                <Link className={'flex items-center gap-2 text-[var(--footer-color)]  p-4 rounded-md'} href={'https://t.me/AMS1381'} target={'_blank'}>
                    <Telegram />
                    <p>Telegram</p>
                </Link>
            ...
            <li>
                <Link className={'flex items-center gap-2 text-[var(--footer-color)] p-4 rounded-md'} href={'https://www.linkedin.com/in/amir-mohammad-solgi-b70390223/'} target={'_blank'}>
                    <LinkedIn />
                    <p>LinkedIn</p>
                </Link>
            </li>
            <li>
                <Link className={'flex items-center gap-2 text-[var(--footer-color)] p-4 rounded-md'} href={'https://github.com/ams1381'} target={'_blank'}>
                    <Instagram />
                    <p>Github</p>
                </Link>
            </li>
