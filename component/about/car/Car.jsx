...
export function DodgeCar(props) {
    ...
    return (
        <group {...props} onClick={() => setEngineOn(true)}
               ...
               position={position}
               receiveShadow={true}
               castShadow={true} dispose={null} >
            {/*{ engineOn && <SmokeParticles engineOn={engineOn}/>}*/}
            {/*<EngineSound engineOn={engineOn} />*/}
            <mesh receiveShadow castShadow geometry={nodes.Object_12.geometry}
            ...
            <mesh receiveShadow castShadow geometry={nodes.Object_1756.geometry}
                  material={materials.dDodge_ChallengerSRTHellcat_2015EngineA_Material1} position={[0, 0.109, -0.113]}
                  scale={0.939}/>
            <mesh receiveShadow castShadow geometry={nodes.Object_1759.geometry}
                  material={materials.dDodge_ChallengerSRTHellcat_2015Grille4A_Material1} position={[0, 0.109, -0.113]}
                  scale={0.939}/>
            <mesh receiveShadow castShadow geometry={nodes.Object_1762.geometry}
