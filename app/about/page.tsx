...
const AboutMePage = () => {
    ...
    return <div className={'w-full bg-[#ededed] dark:bg-[transparent] h-[calc(100%-65px)] absolute flex flex-col gap-2 z-[20] text-center justify-center items-center'}>
        ...
        <div style={{animation: 'showUp 0.5s ease-out', animationFillMode: 'forwards'}}
            ...
            <div
                className={'w-[90%] md:w-auto flex flex-col gap-2 items-center aboutMeCard translate-y-[-20px] p-3 pt-[30px]  rounded-md'}>
                ...
                <Link target={'_blank'} className={'transition-all hover:font-bold'}
                      href={'mailto:amirmohammadsolgi1381@gmail.com'}>
